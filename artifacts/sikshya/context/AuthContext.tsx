...
export const SAMPLE_TEACHERS: Teacher[] = [
  {
    ...
    bio: "Experienced mathematics teacher with 15 years of teaching at higher secondary level. Specializes in making complex concepts simple and accessible.",
  ...
  },
  {
    ...
    bio: "Senior science teacher from Kathmandu. Former lecturer at Tribhuvan University. Passionate about making science accessible.",
    approvalStatus: "approved",
    credentials: [],
    rating: 4.6,
    reviewCount: 89,
  ...
  },
  {
    ...
    role: "teacher",
    subject: "English",
    subjects: ["Grammar", "Literature", "Spoken English"],
    bio: "IELTS certified English teacher. Has helped over 200 students achieve their target band scores.",
    approvalStatus: "approved",
    credentials: [],
    rating: 4.9,
    reviewCount: 203,
  ...
  },
  {
    ...
    role: "teacher",
    subject: "Nepali",
    subjects: ["Nepali Literature", "Grammar", "Writing"],
    bio: "Nepali language and literature expert. Graduate from Tribhuvan University with distinction.",
    approvalStatus: "approved",
    credentials: [],
    rating: 4.5,
    reviewCount: 56,
  ...
  },
  {
    ...
    bio: "Software engineer turned educator. Teaching programming and computer science concepts for 8 years.",
    approvalStatus: "approved",
    credentials: [],
    rating: 4.7,
    reviewCount: 142,
